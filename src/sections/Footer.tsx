const Footer = () => {
    return (
        <footer className="relative py-10 px-6 bg-amber-400">
        ...
        <div className="mx-auto max-w-7xl">
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3">
                <a href="/">
                <img alt="Logo" className="h-12" src="https://www.svgrepo.com/show/340614/logo-slack.svg" />
                </a>
                <p className="my-4 text-gray-700">
                Welcome to YourService.io, where innovation meets reliability. Our mission is to empower developers and
                businesses with cutting-edge tools and services to seamlessly build, deploy, and scale robust applications. At
                YourService.io, we prioritize performance, scalability, and security, ensuring that your full-stack
            ...
            <div className="w-full md:w-2/3">
                ...
                <div>
                    ...
                    <li className="flex w-auto items-center justify-start gap-2">
                        <a href="https://twitter.com/yourserviceio" className="inline-link flex gap-2" target="_blank"
                        rel="noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
